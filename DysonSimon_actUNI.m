function [dydz] = DysonSimon_actUNI(V,pars,yvec)
% 3H2 + N2 <=> 2NH3
...
phiN2  = -5*10^(-8)*(T-273.15)^2 + 4*10^(-5)*(T-273.15) + 1.0240;
phiH2  = +5*10^(-8)*(T-273.15)^2 - 9*10^(-5)*(T-273.15) + 1.0575;
phiNH3 = -8*10^(-7)*(T-273.15)^2 + 0.0009   *(T-273.15) + 0.6958;
