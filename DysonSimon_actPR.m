function [dydz] = DysonSimon_actPR(V,pars,yvec)
% 3H2 + N2 <=> 2NH3
...
phiN2  = +6*10^(-8)*(T-273.15)^2 + 3*10^(-5)*(T-273.15) + 1.0324;
phiH2  = +5*10^(-8)*(T-273.15)^2 - 8*10^(-5)*(T-273.15) + 1.0481;
phiNH3 = -9*10^(-7)*(T-273.15)^2 + 0.0011   *(T-273.15) + 0.6716;
